package com.enation.app.b2b2c.front.api.order.payment;
 ...
 */ 
@Controller
@RequestMapping("/api/b2b2c/store-payment-api")
public class StorePaymentApiController extends GridController{
	@Autowired
