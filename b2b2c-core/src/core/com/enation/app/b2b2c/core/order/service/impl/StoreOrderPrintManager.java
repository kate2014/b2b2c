 ...
 *
 */
@Service("storeOrderPrintManager")
public class StoreOrderPrintManager implements IStoreOrderPrintManager {
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.b2b2c.core.order.service.IStoreOrderPrintManager#getShipScript(java.lang.Integer)
	 */
	@Override
