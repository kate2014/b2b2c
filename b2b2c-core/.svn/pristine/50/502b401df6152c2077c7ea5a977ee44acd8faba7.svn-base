...
import com.enation.app.shop.core.member.plugin.IMemberLogoutEvent;
...
public class B2b2cMemberLogoutPlugin extends AutoRegisterPlugin implements IMemberLogoutEvent{
	...
	public void onLogout(Member member) {
		ThreadContextHolder.getSession().removeAttribute(IStoreMemberManager.CURRENT_STORE_MEMBER_KEY);		
	}
