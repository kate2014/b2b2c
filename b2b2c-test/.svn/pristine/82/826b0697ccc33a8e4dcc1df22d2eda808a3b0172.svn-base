...
*/
public class MemberGoodFavoriteTest extends SpringTestSupport{
	 ...
	 */
	@Test
	public void goodFavoriteNotlogionTest() throws Exception{
	 ...
	 */
	@Test
	public void goodDeleteFavoriteNotloginTest() throws Exception{
	 ...
	 */
	@Test
	public void goodFavoriteLogionTest() throws Exception{
